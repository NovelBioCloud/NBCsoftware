...
\begin{table}[h]
  ...
  \begin{tabular}{cccccccccc}
    \hline
    sampleName & beforeReadsNum & afterReadsNum & beforeLen & afterLen & beforeBaseNum & afterBaseNum & beforeCG\% & afterCG\% & baseFilterRate\% \\\hline
    <#list lsSampleInfoHasBA as sampleInfo>
    ${sampleInfo.sampleName} & ${sampleInfo.beforeReadsNum} & ${sampleInfo.afterReadsNum} & ${sampleInfo.beforeLen} & ${sampleInfo.afterLen} & ${sampleInfo.beforeBaseNum} & ${sampleInfo.afterBaseNum} & ${sampleInfo.beforeCG}\% & ${sampleInfo.afterCG}\% & ${sampleInfo.baseFilterRate}\% \\
    </#list>
    \hline
  \end{tabular}
\end{table}
