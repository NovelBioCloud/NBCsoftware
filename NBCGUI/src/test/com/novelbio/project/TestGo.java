...
public class TestGo {
	...
	public void init(){
		...
		mapParams.put("inputData", new String[]{"/hdfs:/nbCloud/public/test/gopath/A18VSA6-Dif_anno.xls","/hdfs:/nbCloud/public/test/gopath/D6VSD0-Dif_anno.xls"});
...
//		mapParams.put("clusterGoPath", new String[]{});
		...
		mapParams.put("background", new String[]{"/hdfs:/nbCloud/public/test/gopath/maizeBG.txt"});
